...
const Switch = ({isDepth , setCheck} : {isDepth : boolean , setCheck : () => void}) => {
    ...
    return (
        ...
        <label className="group gap-3 flex items-center cursor-pointer">
            <span className="ml-3 dark:text-white text-gray-700 group-hover:text-blue-500 font-medium transition-colors duration-300">
                Deep Search
            </span>
            <input onChange={setCheck} className="hidden peer" type="checkbox" />
