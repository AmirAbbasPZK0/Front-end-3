...
const HyperLink = ({...props} : HyperLinkProps) => {
    ...
    return (<>
        <a className='dark:text-slate-300 relative hover:bg-slate-200 text-slate-900 shadow-md pl-2 pr-2 bg-slate-100 dark:bg-slate-800 rounded-lg p-[2px]' target="_blank" href={props.href}>
            {props.children}
