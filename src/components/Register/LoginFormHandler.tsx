        ...
        <form ref={form} onSubmit={onSubmit} className="flex w-full flex-col gap-6">
          <div className="flex flex-col w-[320px] md:w-[400px] justify-between gap-6">
            ...
            <div className="flex flex-col w-full gap-1">
              ...
              <div className="outline-none flex justify-between bg-white border-2 border-[#d7d7d9] dark:bg-[#111828] rounded-lg focus:border-[#6803f5] py-1 px-2">
                <input
                  type={showPass ? "text" : "password"}
                  name="password"
                  required
                  className="dark:bg-[#111828] outline-none w-full"
                />
                <button type="button" onClick={()=>{
                  setShowPass(item => !item)
                }}>{showPass ? <FaRegEyeSlash/> : <FaRegEye/>}</button>
              </div>
