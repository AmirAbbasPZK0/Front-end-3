...
const Card = ({ Icon, title, desc, color }: CardProps) => {
  return (
    <div className="text-center bg-white dark:bg-[#111828] first:bg-transparent dark:first:bg-transparent flex flex-col justify-between items-center first:justify-normal gap-4 p-12 first:pt-12 rounded-2xl">
